...
namespace ExamCommon
{
    ...
    public class DTRequest
    {
        ...
        //    string ts = string.Format(GetUrl("Key"), host, GetServerString("LOCAL_ADDR"), Utils2.GetVersion());
        //    if (!string.IsNullOrEmpty(host) && host != "localhost")
        //    {
        //        Utils2.GetDomainStr("dt_cache_domain_info", ts);
        //    }
        //    return host;
        //}
        ...
        public static bool IsBrowserGet()
        {
            ...
            string curBrowser = HttpContext.Current.Request.Browser.Type.ToLower();///获取访问的浏览器类型并全部转换为小写
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !Utils2.IsSafeSqlString(HttpContext.Current.Request.Params[strName]))
        ...
        {
            if (HttpContext.Current.Request.Params[strName] == null || HttpContext.Current.Request.Params[strName].ToString() == string.Empty)
                return defaultvalue;
            else
            {
                Regex obj = new Regex("\\d+");
                Match objmach = obj.Match(HttpContext.Current.Request.Params[strName].ToString());
                if (objmach.Success)
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !Utils2.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
        ...
        {
            return Utils2.StrToInt(HttpContext.Current.Request.Params[strName], 0);
        }
        ...
        {
            return Utils2.StrToInt(HttpContext.Current.Request.Params[strName], defValue);
        }
        ...
        {
            return Utils2.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return Utils2.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return Utils2.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return Utils2.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return Utils2.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        //    if (string.IsNullOrEmpty(result) || !Utils2.IsIP(result))
        //        return "127.0.0.1";
        //    return result;
        //}
